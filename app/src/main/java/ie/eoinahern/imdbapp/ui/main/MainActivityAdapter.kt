...
class MainActivityAdapter @Inject constructor() :
    ...
    inner class ViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        private val image: ImageView by lazy { v.findViewById<ImageView>(R.id.movieImage) }
        private val movieTitle: TextView by lazy { v.findViewById<TextView>(R.id.movieTitle) }
        private val movieYear: TextView by lazy { v.findViewById<TextView>(R.id.movieYear) }
        ...
        fun bind(movie: MovieDetails) {
            ...
            val imageurl = IMAGE_URL.plus(movie.poster_path)
